import 'package:flutter_demo/edit_profile.dart';
import 'package:flutter_demo/fetch_api.dart';
import 'package:flutter_demo/hero_animation/hero_animation.dart';
import 'package:flutter_demo/medium_clap.dart';
import 'package:flutter_demo/music_player/music_player.dart';
import 'package:flutter_demo/tool_widget.dart';
      ...
      child: new Center(
        child: new Column(
          children: <Widget>[
            ...
            buildButton(context, 'Tool widget screen', new ToolWidget()),
          ],
        ),
      ),
