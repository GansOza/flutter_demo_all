...
import 'package:flutter_demo/music_player/songs.dart';
import 'package:flutter_demo/music_player/theme.dart';
                  ...
                  return new RichText(
                    text: new TextSpan(text: '', children: [
                      ...
                      new TextSpan(
                          ...
                          style: new TextStyle(
                              color: Colors.white.withOpacity(0.75), fontSize: 12.0, letterSpacing: 3.0, height: 1.5))
                    ]),
