...
import 'package:flutter_demo/restaurant_animation/restaurant_animation.dart';
...
class RestaurantAnimationScreenState2 extends State<RestaurantAnimationScreen2> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    zoomPlateAnim1 = new Tween(begin: 0.0, end: 0.4)
        .animate(new CurvedAnimation(parent: animControlPhrase2, curve: new Interval(0.0, 1.0)));
    ...
    zoomPlateAnim2 = new Tween(begin: 0.0, end: 0.4)
              ...
              child: new Column(
                children: <Widget>[
                  new Transform.scale(
                    ...
                    scale: whichPlatePressed == 1 ? value : 1.0,
                  ),
                  new Text('Flan',
                      style: new TextStyle(
              ...
              child: new Column(
                children: <Widget>[
                  new Transform.scale(
                    ...
                    scale: whichPlatePressed == 2 ? value : 1.0,
                  ),
                  new Text('Curry',
                      style: new TextStyle(
                        color: new Color(0xFF575869),
              ...
              child: new Column(
                children: <Widget>[
                  new Transform.scale(
                    ...
                    scale: whichPlatePressed == 3 ? value : 1.0,
                  ),
